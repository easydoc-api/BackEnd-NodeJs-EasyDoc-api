...
const appointmentZeroCreateService = async ({paridade, consanguinidade, idadeGestacional, dataMenstruacao, primeiroUltrassom, semanaGestacional, diaGestacional, historiaPregressa, historiaGinecologicaObstetrica}: IConsultZeroRequest) => {
