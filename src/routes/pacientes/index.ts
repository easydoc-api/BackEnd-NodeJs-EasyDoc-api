...
export const patientRoutes = () => {
  patient.post("/register", schemaValidationMiddleware(newPatientSchema),authTokenMiddleware,isAdmMiddleware, patientCreateController) 
  ...
  patient.delete("/:id",authTokenMiddleware,isAdmMiddleware, patientDeleteController) 
