...
export class firstMigration1663075755900 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "exames_laboratoriais" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "atualizadoEm" TIMESTAMP NOT NULL DEFAULT now(), "data" TIMESTAMP NOT NULL DEFAULT now(), "gs_rh" character varying(20), "coombs" character varying(20), "hb_ht" character varying(20), "plaq" character varying(20), "gj" character varying(20), "gpd" character varying(20), "vdrl" character varying(20), "hbsag" character varying(20), "antiHiv" character varying(20), "antiHcv" character varying(20), "antiHtlv" character varying(20), "toxop" character varying(20), "rubeola" character varying(20), "cmv" character varying(20), "tsh" character varying(20), "eas" character varying(20), "urocult" character varying(20), "strep" character varying(20), "eletro" character varying(20), "estaAtivo" boolean NOT NULL DEFAULT true, "prontuarioId" uuid, CONSTRAINT "PK_25ba8616f9471fa3a8598d3f24c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "medicos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "criadoEm" TIMESTAMP NOT NULL, "atualizadoEm" TIMESTAMP NOT NULL, "nome" character varying(200) NOT NULL, "email" character varying(200) NOT NULL, "senha" character varying(200) NOT NULL, "categoria" character varying(200) NOT NULL, "estaAtivo" boolean NOT NULL DEFAULT true, "adm" boolean NOT NULL DEFAULT false, "prontuarioId" uuid, CONSTRAINT "UQ_c12f2495d17fc6428bb6dfdbad7" UNIQUE ("email"), CONSTRAINT "PK_f16d578e9fd6df731d5e8551725" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "prontuarios" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "estaAtivo" boolean NOT NULL DEFAULT true, "pacienteId" uuid, "consultaZeroId" uuid, CONSTRAINT "REL_836d540c88b70704037f9fc35d" UNIQUE ("pacienteId"), CONSTRAINT "REL_27fb6fb9baff8da7eac56ef4e8" UNIQUE ("consultaZeroId"), CONSTRAINT "PK_1c9bdb8e627734fe730830832f8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "pacientes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "criadoEm" TIMESTAMP NOT NULL DEFAULT now(), "atualizadoEm" TIMESTAMP NOT NULL DEFAULT now(), "estaAtivo" boolean NOT NULL DEFAULT true, "nome" character varying NOT NULL, "cpf" character varying NOT NULL, "email" character varying NOT NULL, "dataNascimento" date NOT NULL, "cidadeOrigem" character varying NOT NULL, "idade" integer NOT NULL, "nomeBebe" character varying(200), "nomePai" character varying(200), "diagnostico" character varying NOT NULL, "procedimentos" character varying NOT NULL, "cariotipo" character varying(20), "prontuario_id" uuid, CONSTRAINT "UQ_d6737b831d4e311678dfce056b6" UNIQUE ("cpf"), CONSTRAINT "REL_2a3fb53e23dd71aed1115166cc" UNIQUE ("prontuario_id"), CONSTRAINT "PK_aa9c9f624ff22fc06c44d8b1609" PRIMARY KEY ("id"))`);
