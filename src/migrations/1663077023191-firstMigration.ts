...
export class firstMigration1663077023191 implements MigrationInterface {
    name = 'firstMigration1663077023191'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "medicos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "criadoEm" TIMESTAMP NOT NULL, "atualizadoEm" TIMESTAMP NOT NULL, "nome" character varying(2000) NOT NULL, "email" character varying(2000) NOT NULL, "senha" character varying(200) NOT NULL, "categoria" character varying(200) NOT NULL, "estaAtivo" boolean NOT NULL DEFAULT true, "adm" boolean NOT NULL DEFAULT false, "prontuarioId" uuid, CONSTRAINT "UQ_c12f2495d17fc6428bb6dfdbad7" UNIQUE ("email"), CONSTRAINT "PK_f16d578e9fd6df731d5e8551725" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "pacientes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "criadoEm" TIMESTAMP NOT NULL DEFAULT now(), "atualizadoEm" TIMESTAMP NOT NULL DEFAULT now(), "estaAtivo" boolean NOT NULL DEFAULT true, "nome" character varying NOT NULL, "cpf" character varying NOT NULL, "email" character varying NOT NULL, "dataNascimento" date NOT NULL, "cidadeOrigem" character varying NOT NULL, "idade" integer NOT NULL, "nomeBebe" character varying(2000), "nomePai" character varying(2000), "diagnostico" character varying NOT NULL, "procedimentos" character varying NOT NULL, "cariotipo" character varying(200), "prontuario_id" uuid, CONSTRAINT "UQ_d6737b831d4e311678dfce056b6" UNIQUE ("cpf"), CONSTRAINT "REL_2a3fb53e23dd71aed1115166cc" UNIQUE ("prontuario_id"), CONSTRAINT "PK_aa9c9f624ff22fc06c44d8b1609" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "consultas" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "data" TIMESTAMP NOT NULL DEFAULT now(), "atualizadoEm" TIMESTAMP NOT NULL DEFAULT now(), "idadeGestacional" integer NOT NULL, "peso" numeric(4,3) NOT NULL, "pressãoArterial" character varying(500) NOT NULL, "uteroFita" character varying(1000), "apresentacao" character varying(1000), "movimentacaoFetal" boolean, "batimentoCardFetal" character varying(100), "edema" character varying(1000), "toqueVaginal" character varying(2000), "conduta" character varying(2000) NOT NULL, "retorno" date, "estaAtivo" boolean NOT NULL DEFAULT true, "prontuarioId" uuid, CONSTRAINT "PK_889a9011f1854a60a6aae1c6d80" PRIMARY KEY ("id"))`);
